        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-24">
          <div className="max-w-3xl">
            ...
            <p className="animate-fade-up-2 text-lg text-[hsl(215_20%_65%)] leading-relaxed max-w-2xl mb-10">
              Consultez, recherchez et exploitez les données officielles des
              médicaments algériens. Une source de vérité unique, sécurisée et
              disponible pour tous les acteurs de santé.
            </p>
